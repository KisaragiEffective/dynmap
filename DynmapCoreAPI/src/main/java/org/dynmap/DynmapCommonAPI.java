...
public interface DynmapCommonAPI {    
     ...
     */
    boolean sendBroadcastToWeb(String sender, String msg);
    /**
     ...
     */
    int triggerRenderOfVolume(String wid, int minx, int miny, int minz, int maxx, int maxy, int maxz);
    /**
     ...
     * @return number of tiles queued to be rerendered (@deprecated return value - just returns 0)
     */
    int triggerRenderOfBlock(String wid, int x, int y, int z);
    /*
     ...
     */
    void setPlayerVisiblity(String player, boolean is_visible);
    /**
     ...
     */
    boolean getPlayerVisbility(String player);
    /**
     ...
     */
    void assertPlayerInvisibility(String player, boolean is_invisible, String plugin_id);
    /**
     ...
     * @param plugin_id - ID of asserting plugin
     */
    void assertPlayerVisibility(String player, boolean is_visible, String plugin_id);
    /**
     ...
     */
    void postPlayerMessageToWeb(String playerid, String playerdisplay, String message);
    /**
     ...
     */
    void postPlayerJoinQuitToWeb(String playerid, String playerdisplay, boolean isjoin);
    /**
     ...
     */
    boolean setDisableChatToWebProcessing(boolean disable);
    /**
     ...
     */
    boolean testIfPlayerVisibleToPlayer(String player, String player_to_see);
    /**
     ...
     * @param playerid - player ID
     */
    void processSignChange(String material, String world, int x, int y, int z, String[] lines, String playerid);
}

...
public interface ModModelDefinition {
     ...
     */
    VolumetricBlockModel addVolumetricModel(int blockid, int scale);
    /**
     * Add volumetric model : default assumes all metadata values are matching
     ...
     * @return block model: use methods to set occupied subblocks
     */
    VolumetricBlockModel addVolumetricModel(String blockname, int scale);
    /**
     * Add standard stair model : default assumes all metadata values are matching
     * @param blockid - block ID
     * @return block model record
     */
    StairBlockModel addStairModel(int blockid);
    /**
     * Add standard stair model : default assumes all metadata values are matching
     * @param blockname - block name
     * @return block model record
     */
    StairBlockModel addStairModel(String blockname);
    /**
     ...
     * @return block model record
     */
    WallFenceBlockModel addWallFenceModel(int blockid, WallFenceBlockModel.FenceType type);
    /**
     * Add wall or fence model : default assumes all metadata values are matching
     * @param blockname - block name
     * @param type - type of wall or fence
     * @return block model record
     */
    WallFenceBlockModel addWallFenceModel(String blockname, WallFenceBlockModel.FenceType type);
    /**
     * Add cuboid model : default assumes all metadata values are matching
     * @param blockid - block ID
     * @return block model record
     */
    CuboidBlockModel addCuboidModel(int blockid);
    /**
     * Add cuboid model : default assumes all metadata values are matching
     * @param blockname - block name
     * @return block model record
     */
    CuboidBlockModel addCuboidModel(String blockname);
    /**
     * Add pane model : default assumes all metadata values are matching
     * @param blockid - block ID
     * @return block model record
     */
    PaneBlockModel addPaneModel(int blockid);
    /**
     * Add pane model : default assumes all metadata values are matching
     * @param blockname - block name
     * @return block model record
     */
    PaneBlockModel addPaneModel(String blockname);
    /**
     * Add standard plant model : default assumes all metadata values are matching
     * @param blockid - block ID
     * @return block model record
     */
    PlantBlockModel addPlantModel(int blockid);
    /**
     * Add standard plant model : default assumes all metadata values are matching
     * @param blockname - block name
     * @return block model record
     */
    PlantBlockModel addPlantModel(String blockname);
    /**
     * Add standard box model : default assumes all metadata values are matching
     * @param blockid - block ID
     * @return block model record
     */
    BoxBlockModel addBoxModel(int blockid);
    /**
     * Add standard box model : default assumes all metadata values are matching
     * @param blockname - block name
     * @return block model record
     */
    BoxBlockModel addBoxModel(String blockname);
    /**
     * Add door model
     * @param blockid - block ID
     * @return block model record
     */
    DoorBlockModel addDoorModel(int blockid);
    /**
     * Add door model
     * @param blockname - block name
     * @return block model record
     */
    DoorBlockModel addDoorModel(String blockname);
    /**
     * Add patch box model : default assumes all metadata values are matching
     * @param blockid - block ID
     * @return block model record
     */
    PatchBlockModel addPatchModel(int blockid);
    /**
     * Add patch box model : default assumes all metadata values are matching
     * @param blockname - block name
     * @return block model record
     */
    PatchBlockModel addPatchModel(String blockname);
    /**
     ...
     * @return block model record
     */
    PatchBlockModel addRotatedPatchModel(int blockid, PatchBlockModel model, int xrot, int yrot, int zrot);
    /**
     * Add rotated patch box model, based on existing model : default assumes all metadata values are matching
     * @param blockname - block name
     * @param model - existing model to be rotated
     ...
     * @return block model record
     */
    PatchBlockModel addRotatedPatchModel(String blockname, PatchBlockModel model, int xrot, int yrot, int zrot);
    /**

...
public interface ModTextureDefinition {
     ...
     */
    void setTexturePath(String txtpath);
    /**
     ...
     */
    GridTextureFile registerTextureFile(String id);
    /**
     ...
     * @return TextureFile associated with resource
     */
    GridTextureFile registerTextureFile(String id, String filename);
    /**
     ...
     * @return TextureFile associated with resource
     */
    ChestTextureFile registerChestTextureFile(String id, String filename);
    /**
     ...
     * @return TextureFile associated with resource
     */
    BigChestTextureFile registerBigChestTextureFile(String id, String filename);
    /**
     ...
     * @return TextureFile associated with resource
     */
    SignTextureFile registerSignTextureFile(String id, String filename);
    /**
     ...
     * @return TextureFile associated with resource
     */
    SkinTextureFile registerSkinTextureFile(String id, String filename);
    /**
     ...
     * @return TextureFile associated with resource
     */
    ShulkerTextureFile registerShulkerTextureFile(String id, String filename);
    /**
     ...
     * @return TextureFile associated with resource
     */
    GridTextureFile registerGridTextureFile(String id, String filename, int xcount, int ycount);
    /** 
     ...
     */
    CustomTextureFile registerCustomTextureFile(String id, String filename, int xcount, int ycount);
    /**
     ...
     * @return TextureFile associated with resource
     */
    BiomeTextureFile registerBiomeTextureFile(String id, String filename);
     ...
     */
    BlockTextureRecord addBlockTextureRecord(int blockID);
    /**
     * Add block texture record : default assumes all metadata values are matching
     * @param blockname - block name 
     * @return block texture record: use methods to set texture use on faces/patches
     */
    BlockTextureRecord addBlockTextureRecord(String blockname);
    /**
     ...
     * @return block texture record: use methods to set texture use on faces/patches
     */
    CopyBlockTextureRecord addCopyBlockTextureRecord(int blockID, int srcBlockID, int srcMeta);
    /**
     * Add block texture record, based on copying a record : default assumes all metadata values are matching
     * @param blockname - block name 
     ...
     * @return block texture record: use methods to set texture use on faces/patches
     */
    CopyBlockTextureRecord addCopyBlockTextureRecord(String blockname, String srcBlockname, int srcMeta);
}

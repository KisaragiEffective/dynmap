...
public interface BlockTextureRecord {
     ...
     */
    void setSideTexture(String txtFileID, BlockSide side);
    /**
     * Set side texture (standard cube block model)
     * @param txtFile - texture file (first texture in file used)
     * @param side - side to apply texture to
     */
    void setSideTexture(TextureFile txtFile, BlockSide side);
    /**
     ...
     * @param side - side to apply texture to
     */
    void setSideTexture(String txtFileID, int txtIndex, BlockSide side);
    /**
     ...
     * @param side - side to apply texture to
     */
    void setSideTexture(TextureFile txtFile, int txtIndex, BlockSide side);
    /**
     ...
     * @param side - side to apply texture to
     */
    void setSideTexture(String txtFileID, TextureModifier modifier, BlockSide side);
    /**
     ...
     * @param side - side to apply texture to
     */
    void setSideTexture(TextureFile txtFile, TextureModifier modifier, BlockSide side);
    /**
     ...
     * @param side - side to apply texture to
     */
    void setSideTexture(String txtFileID, int txtIndex, TextureModifier modifier, BlockSide side);
    /**
     * Set side texture (standard cube block model) with texture modifier and texture index
     * @param txtFile - texture file
     * @param txtIndex - texture index
     ...
     * @param side - side to apply texture to
     */
    void setSideTexture(TextureFile txtFile, int txtIndex, TextureModifier modifier, BlockSide side);
    /**
     * Set patch texture
     * @param txtFileID - texture file ID (first texture in file used)
     * @param patchIndex - patch index to apply texture to
     */
    void setPatchTexture(String txtFileID, int patchIndex);
    /**
     * Set patch texture
     * @param txtFile - texture file (first texture in file used)
     * @param patchIndex - patch index to apply texture to
     */
    void setPatchTexture(TextureFile txtFile, int patchIndex);
    /**
     ...
     * @param patchIndex - patch index to apply texture to
     */
    void setPatchTexture(String txtFileID, int txtIndex, int patchIndex);
    /**
     ...
     * @param patchIndex - patch index to apply texture to
     */
    void setPatchTexture(TextureFile txtFile, int txtIndex, int patchIndex);
    /**
     ...
     * @param patchIndex - patch index to apply texture to
     */
    void setPatchTexture(String txtFileID, TextureModifier modifier, int patchIndex);
    /**
     ...
     * @param patchIndex - patch index to apply texture to
     */
    void setPatchTexture(TextureFile txtFile, TextureModifier modifier, int patchIndex);
    /**
     ...
     * @param patchIndex - patch index to apply texture to
     */
    void setPatchTexture(String txtFileID, int txtIndex, TextureModifier modifier, int patchIndex);
    /**
     * Set patch texture with texture modifier and texture index
     * @param txtFile - texture file
     * @param txtIndex - texture index
     ...
     * @param patchIndex - patch index to apply texture to
     */
    void setPatchTexture(TextureFile txtFile, int txtIndex, TextureModifier modifier, int patchIndex);
    /**
     * Get texture ID for given side
     * @param side - side
     * @return texture ID
     */
    String getSideTextureID(BlockSide side);
    /**
     * Get texture modifier for given side
     * @param side - side
     * @return texture modifier
     */
    TextureModifier getSideTextureModifier(BlockSide side);
    /**
     * Get texture index for given side
     * @param side - side
     * @return texture index
     */
    int getSideTextureIndex(BlockSide side);
    /**
     * Get texture ID for given patch index
     * @param patchIndex - patch index
     * @return texture ID
     */
    String getPatchTextureID(int patchIndex);
    /**
     * Get texture modifier for given patch index
     * @param patchIndex - patch index
     * @return texture modifier
     */
    TextureModifier getPatchTextureModifier(int patchIndex);
    /**
     * Get texture index for given patch index
     * @param patchIndex - patch index
     * @return texture index
     */
    int getPatchTextureIndex(int patchIndex);
    
    /**
     * Set block color map
     * @param txtFileID - texture file ID
     */
    void setBlockColorMapTexture(String txtFileID);
    /**
     * Set block color map
     * @param txtFile - texture file
     */
    void setBlockColorMapTexture(TextureFile txtFile);

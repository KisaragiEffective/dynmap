...
public interface DynmapAPI extends DynmapCommonAPI {
     ...
     */
    int triggerRenderOfVolume(Location l0, Location l1);
    /**
     * Set player visibility
     * @param player - player
     * @param is_visible - true if visible, false if hidden
     */
    void setPlayerVisiblity(Player player, boolean is_visible);
    /**
     ...
     */
    void assertPlayerInvisibility(Player player, boolean is_invisible, Plugin plugin);
    /**
     ...
     * @param plugin - asserting plugin
     */
    void assertPlayerVisibility(Player player, boolean is_visible, Plugin plugin);
}
